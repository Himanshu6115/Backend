...
public class EmployeeController {
	...
	public List<TimesheetDetails> getNotApproved(@RequestParam("supervisorName") String supervisorName) throws FileNotFoundException {
		
		List<TimesheetDetails> listEmp = new ArrayList();
	...
	public List<TimesheetDetails> getNotSubmitted(@RequestParam("supervisorName") String supervisorName) throws FileNotFoundException {
		
		ArrayList<TimesheetDetails> listEmp= new ArrayList();
